...
var AbstractItem = function(widget,platform,homebridge,output,input) {
    ...
    this.name = this.platform.inputs[input] + " " + this.platform.outputs[output];
    this.log("TRYING TO ADD NAME: " + this.name);
